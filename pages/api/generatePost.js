  ...
  try {
    ...
    const postContentResult = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a blog post generator. All your answers must be in spanish',
        },
        {
          role: 'user',
    ...
    const metaDescriptionResult = await openai.createChatCompletion({
      ...
      limited to the following HTML tags: p, h1, h2, h3, h4, h5, h6, strong, i, ul, li, ol.`,
        ...
        },
        {
          role: 'user',
          content:
            'Generate SEO-friendly meta description content for the above blog post. All your answers must be in spanish',
        },
      ],
      temperature: 0,
    });
